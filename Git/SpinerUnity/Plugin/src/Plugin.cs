...
using System.IO;
using JusticeEnemy.Configuration;
...
namespace JusticeEnemy {
    ...
    public class Plugin : BaseUnityPlugin {
        ...
        private void Awake() {
            ...
            var JusticeEnemy = ModAssets.LoadAsset<EnemyType>("JusticeEnemyObj");
            var JusticeEnemyTN = ModAssets.LoadAsset<TerminalNode>("JusticeEnemyTN");
            var JusticeEnemyTK = ModAssets.LoadAsset<TerminalKeyword>("JusticeEnemyTK");

            // Optionally, we can list which levels we want to add our enemy to, while also specifying the spawn weight for each.
            /*
            var JusticeEnemyLevelRarities = new Dictionary<Levels.LevelTypes, int> {
            ...
            var JusticeEnemyCustomLevelRarities = new Dictionary<string, int> {
                {"EGyptLevel", 50},
            ...
            */
            ...
            NetworkPrefabs.RegisterNetworkPrefab(JusticeEnemy.enemyPrefab);
            ...
            Enemies.RegisterEnemy(JusticeEnemy, BoundConfig.SpawnWeight.Value, Levels.LevelTypes.All, JusticeEnemyTN, JusticeEnemyTK);
            // For using our rarity tables, we can use the following:
            // Enemies.RegisterEnemy(JusticeEnemy, JusticeEnemyLevelRarities, JusticeEnemyCustomLevelRarities, JusticeEnemyTN, JusticeEnemyTK);
