...
namespace Spiner
{
    public class SpinerAI : EnemyAI, INoiseListener
    {
        ...
        public void StartAttack()
        {
            ...
            SpinerPlugin.Logger.LogInfo("[Spiner] ⚔️ Start Attack");
            isAttacking = true;
        ...
        {
            SpinerPlugin.Logger.LogInfo($"[Spiner] ⚔️ Attack started!");
        ...
        public override void DetectNoise(Vector3 noisePosition, float noiseLoudness, int timesPlayedInOneSpot = 0, int noiseID = 0)
        {
            ...
            // 🔴 1️⃣ Vérification : L'ennemi **n'écoute que lorsqu'il est en Patrouille** !
            ...
            // 🔴 2️⃣ Vérification : **Cooldown du bruit**
            ...
            // 🔴 3️⃣ Vérification : **Éviter la détection de bruits similaires en boucle**
